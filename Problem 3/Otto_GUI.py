...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox = QtWidgets.QComboBox(self.gb_Input)
        # Creating a comboBox in Qt Designer that switches between Diesel and Otto cycle
        ...
        self.comboBox.currentIndexChanged['int'].connect(Form.OttoOrDieselSelected)
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox.setItemText(0, _translate("Form", "Otto Cycle"))
        self.comboBox.setItemText(1, _translate("Form", "Diesel Cycle"))
